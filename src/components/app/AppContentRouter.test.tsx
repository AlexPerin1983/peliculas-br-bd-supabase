...
describe('AppContentRouter', () => {
  const baseProps = {
    ...
    onLoadMoreHistoryPdfs: vi.fn().mockResolvedValue(undefined),
    onEnsureCompleteHistory: vi.fn().mockResolvedValue(undefined),
    clients: [],
    clientListClients: [],
    hasLoadedAllClients: true,
    clientListHasMore: false,
    isClientListLoading: false,
    onLoadMoreClientList: vi.fn().mockResolvedValue(undefined),
    onSearchClientList: vi.fn().mockResolvedValue(undefined),
    clientTotalCount: 0,
